...
report : dict = evaluation.evaluateRagPrediction(
    contextLength=32,
    predictionLength=16,
    numberSamples=100,
    dataset="ET",
...
report : dict = evaluation.compileReports(reportOriginName="evaluationReportsMoiraiMoERagOnlySoftMax",reportTargetName="evaluationFinalReportMoiraiMoERagOnlySoftMax")